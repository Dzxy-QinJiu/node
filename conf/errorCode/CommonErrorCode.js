...
function getConfigJson(req) {
    ...
    return {
        ...
        //操作参数错误
        '10001': {'httpCode': 500, 'message': ''},//参数错误
        /****************  成员 *******************/
        ...
        //缺少必要参数
        '12006': {'httpCode': 500, 'message': ''},//参数错误
        ...
        //更新内容是空不做处理
        '14012': {'httpCode': 500, 'message': ''},//参数错误
        //团队管理员才有权限处理
        ...
        //角色操作参数错误
        '15105': {'httpCode': 500, 'message': ''},//参数错误
        ...
        //权限操作参数错误
        '15205': {'httpCode': 500, 'message': ''},//参数错误
        ...
        //用户组操作参数错误
        '16210': {'httpCode': 500, 'message': ''},//参数错误
        ...
        '17197': {'httpCode': 500, 'message': ''},//参数错误
        //缺少必要的参数
        '17198': {'httpCode': 500, 'message': ''},//参数错误
        //该用户角色无分析权限
        ...
        //请求缺少token
        '19200': {'httpCode': 500, 'message': ''},//参数错误
        //请求缺少userId
        '19201': {'httpCode': 500, 'message': ''},//参数错误，界面上不提示此类错误，展示具体的错误描述
        //请求缺少realm
        '19202': {'httpCode': 500, 'message': ''},//参数错误
        ...
        '20002': {'httpCode': 500, 'message': ''},//非法请求，界面上不提示此类错误，展示具体的错误描述
        /*扫码登录*/
