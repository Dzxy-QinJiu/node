...
function getConfigJson(req) {
    ...
    return {
        ...
        '10219': {'httpCode': 500, 'message': backendIntl.get('errorcode.has.user', '该时间段已发过申请')},
        ...
        //找回密码时，前三次短信验证码验证错误
        '11541': {'httpCode': 500, 'message': backendIntl.get('login.forgot.password.phone.code.error', '短信验证码错误')},
        ...
        //用户不存在，业务端的登录接口报的错误
        '20009': {'httpCode': 500, 'message': backendIntl.get('login.account.unregister', '该账号尚未注册')},
