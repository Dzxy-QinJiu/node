...
var config = {
    ...
    pushServerAddress: process.env.PUSH_SERVER_ADDRESS || 'http://10.20.2.60:9093',//推送的服务地址（测试： http://10.20.1.184:9093，正式:http://notify-ketao.antfact.com:80）
    ...
    antmeActorUrl: process.env.ANTME_ACTOR_URL || 'wss://platform-dev.antme.io:9080',//蚁讯socketio地址, 测试：'wss://platform-dev.antme.io:9080', exp：'wss://platform-exp.antme.io:9080', 正式: 'wss://platform.antme.io:9080'
