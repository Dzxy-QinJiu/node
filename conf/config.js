...
var config = {
    ...
    pushServerAddress: process.env.PUSH_SERVER_ADDRESS || 'http://notify-ketao.antfact.com:80',//推送的服务地址（测试： http://172.19.103.211:9093，正式:http://notify-ketao.antfact.com:80）
