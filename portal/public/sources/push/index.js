...
// 升级后，当前版本时间的监听及刷新提示的展示
function upgradeRefreshListener(newUpgradeTime){
...
function applyUnreadReplyListener(unreadReply) {
    ...
    //member_id 推送给的人的id，需要校验的是这条审批的申请人的id是不是当前登录人，如果是，推送到我的申请这个tab
    console.log(userData.getUserData().user_id);
