            ...
            <div className="user-agreement-wrap" data-tracename="用户协议">
                ...
                <div className='user-agreement-content' style={{ height: contentHeight }}>
                    <GeminiScrollbar>
                        ...
                        <div className='content-text'>欢迎您使用客套的服务！</div>
                        ...
                        <div className='content-text'>如果您未满18周岁，请在法定监护人的陪同下阅读本协议，并特别注意未成年人使用条款。</div>
                        <div className='content-title'>一、【协议的范围】</div>
                        <div className='content-title'>1.1【协议适用主体范围】</div>
                        <div className='content-text'>本协议是您与山东客套智能科技有限公司之间关于您使用本网站，以及使用客套相关服务所订立的协议。山东客套智能科技有限公司，以下简称“客套智能科技”或“客套”。“用户”是指客套服务的使用人，在本协议中更多地称为“您”。</div>
                        ...
                        <div className='content-text'>本服务的具体内容由客套智能科技根据实际情况提供，包括但不限于授权用户通过其客套帐号管理自己的客户信息，客套智能科技有权对其提供的服务进行扩展。（以下简称“本服务”）</div>
                        ...
                        <div className='content-text'>4.1 客套web端仅需要安装最新版的浏览器即可注册和登录使用。</div>
                        <div className='content-text'>4.2 客套智能科技可能还为不同的终端设备开发了不同的软件版本，您应当根据实际情况选择下载合适的版本进行安装。下载安装程序后，您需要按照该程序提示的步骤正确安装。为提供更加优质、安全的服务，在本软件安装时客套智能科技可能推荐您安装其他软件，您可以选择安装或不安装。如果您不再需要使用本软件或者需要安装新版软件，可以自行卸载。</div>
                        ...
                        <div className='content-text'>6.5 客套智能科技不会将您的个人信息转移或披露给任何第三方，除非：</div>
                        <div className='content-text'>（1）相关法律法规或司法机关、行政机关要求；或</div>
                        <div className='content-text'>（2）为完成合并、分立、收购或资产转让而转移；或</div>
                        <div className='content-text'>（3）为提供您要求的服务所必需。</div>
                        ...
                        <div className='content-text'>（1） 客套智能科技不对您在本软件及服务中相关数据的删除或储存失败负责；</div>
                        <div className='content-text'>（2） 客套智能科技有权根据实际情况自行决定单个用户在本软件及服务中数据的最长储存期限，并在服务器上为其分配数据最大存储空间等。您可根据自己的需要自行备份本软件及服务中的相关数据；</div>
                        ...
                        <div className='content-text'>（1） 由于不可抗拒因素可能引起的个人信息丢失、泄漏等风险；</div>
                        <div className='content-text'>（2） 用户必须选择与所安装终端设备相匹配的软件版本，否则，由于软件与终端设备型号不相匹配所导致的任何问题或损害，均由用户自行承担；</div>
                        <div className='content-text'>（3） 用户在使用本软件访问第三方网站时，因第三方网站及相关内容所可能导致的风险，由用户自行承担；</div>
                        <div className='content-text'>（4） 用户发布的内容被他人转发、分享，因此等传播可能带来的风险和责任；</div>
                        ...
                        <div className='content-text'>7.4.2 您成为客套的会员的方式:</div>
                        <div className='content-text'>（1） 您必须先填写真实、准确的信息注册成为客套用户。您一旦成为客套用户，即视为您授权客套智能科技通过“客套”平台为您获取、汇总、整理、提供政府及网络公开的公共数据。您通过客套提供的付款方式付费成功后，即成为客套的会员，您确保所填写的内容与个人资料必须真实有效，否则我们有权拒绝您的申请或撤销您的会员资格，并不予任何赔偿或退还会员服务费。会员的个人资料发生变化，应及时修改注册的个人资料，否则由此造成的会员权利不能全面有效行使的责任由会员自己承担，客套有权因此取消您的会员资格，并不予退还会员费或其他任何形式的任何赔偿。</div>
                        <div className='content-text'>（2） 您应通过客套指定的购买渠道成为客套会员，获取客套服务。您在成为会员前，须阅读并确认接受相关的服务条款和使用方法。客套在此声明：任何通过非客套渠道购买的账户，客套有权回收，并有权追究其法律责任。</div>
                        <div className='content-text'>（3） 您应通过客套指定支付渠道支付客套会员服务费用（包括网银支付或第三方支付等方式），您在支付会员服务费用之前，须认可该项服务标明之价格，确认接受相关的服务条款及支付条款，严格按照支付流程操作，并在支付时注意及确保支付环境安全，否则应自行承担全部不利后果。</div>
                        <div className='content-text'>（4） 若您通过对公转账方式购买客套会员/企业套餐，需严格按照页面提示支付费用，客套确认收到您支付的款项后将为您激活会员服务，客套会员服务即时生效并开始计算服务期限。您在成为客套会员后可申请开票，您需确保付款主体与开票抬头保持一致，并且开票抬头不可更改，若因您的疏忽造成开票错误、重复扣税等情况，您将承担全部责任。</div>
                        <div className='content-text'>（5） 会员的服务价格以客套网站上标注的详细资费标价为准，客套对会员的服务有修改价格、升级服务、增减服务内容等权利。会员的增值服务标准以客套产品上标注的详细资费标价为准。您可以登录客套后在个人资料中查询您的账号信息详情。 </div>
                        ...
                        <div className='content-text'>7.4.3 您理解并同意以下会员服务的使用规范：</div>
                        <div className='content-text'>（1） 会员服务有固定的服务使用期限，您一旦成为会员即视为认可客套的服务使用期限。服务使用期限指成功付费（线下支付以到帐日期为准）起到购买的使用周期结束，如：5月20日购买1个月会员并付费成功，则使用期限到6月19日结束（非5月31日结束）。会员服务仅限于申请账号自行使用；会员服务期内不能在客套帐号之间转移，禁止赠与、借用、转让或售卖。否则客套有权在未经通知的情况下取消转让账户、受让账户的会员服务资格，由此带来的损失由会员自行承担。</div>
                        <div className='content-text'>（2） 若会员的行为持续违反本协议或违反国家相关法律法规，或客套认为会员行为有损客套或他人的声誉及利益，我们有权取消该会员的会员资格而无须给予任何补偿。</div>
                        <div className='content-text'>（3） 客套内所有的企业联系方式来源于已公开的企业年报或网络公开信息，仅供用户查询之用。用户查看或导出企业相关信息后，不得用于买卖、交换等用途，若由此引起的任何纠纷由行为人承担，客套不承担任何责任。</div>
                        <div className='content-text'>（4） 任何会员不得使用带有非法、淫秽、污辱或人身攻击的昵称和评论，一经发现，客套有权取消其会员资格而无需给与任何补偿和退费。</div>
                        <div className='content-text'>（5） 您应自行负责妥善且正确地保管、使用、维护您在客套申请取得的账户、账户信息及账户密码。非因客套原因致使您账户密码泄漏以及因您保管、使用、维护不当造成损失的，客套无须承担与此有关的任何责任。</div>
                        <div className='content-text'>（6） 客套不对您因第三方的行为或不作为造成的损失承担任何责任，包括但不限于支付服务和网络接入服务、任意第三方的侵权行为。</div>
                        <div className='content-text'>（7） 成为会员后，您有权停止或放弃接受客套服务，并有权注销客套用户账户，但客套无须向您退还已支付的任何费用。</div>
                        <div className='content-text'>（8） 您知悉并同意，客套平台仅就您提交的查询内容做识别应答，查询结果与提交的内容主体是否相符由您负责掌握和判断。客套向您返回的数据结果，不构成客套对任何人之明示或暗示的观点或保证。</div>
                        <div className='content-text'>7.4.4 您理解并同意，您会员账号内的行为（包括但不限于信息查询、信息发布等）均代表您本人行为，您应妥善保管您的账号及密码，并对该账号下的所有行为承担责任。</div>
                        <div className='content-text'> 为保障您的账号安全，确保您的账号不被他人违规使用，您不应通过客套官方渠道之外的其他途径获取或使用客套会员账号，或为他人通过其他途径获取或使用客套会员账号提供条件。否则，客套有权视具体违规情节，采取强制修改密码直至封禁相关会员账号等措施，暂停或终止为您提供服务，并无须退还任何费用。违规使用情形包括：</div>
                        <div className='content-text'>（1） 未经客套事先明示同意，转让、借用、出租、赠与或以其他方式，为他人使用您的会员账号提供条件；</div>
                        ...
                        <div className='content-text'>（1） 发布、传送、传播、储存违反国家法律、危害国家安全统一、社会稳定、公序良俗、社会公德以及侮辱、诽谤、淫秽或含有任何性或性暗示的、暴力的内容；</div>
                        <div className='content-text'>（2） 发布、传送、传播、储存侵害他人名誉权、肖像权、知识产权、商业秘密等合法权利的内容；</div>
                        <div className='content-text'>（3） 涉及他人隐私、个人信息或资料的；</div>
                        <div className='content-text'>（4） 发表、传送、传播骚扰、广告信息及垃圾信息；</div>
