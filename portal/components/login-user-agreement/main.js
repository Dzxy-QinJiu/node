            ...
            <div className="user-agreement-wrap" data-tracename="用户协议">
                ...
                <div className='user-agreement-content' style={{ height: contentHeight }}>
                    <GeminiScrollbar>
                        ...
                        <div className='content-text'>2.2.1 您使用本服务需要登录客套客户端软件，本服务中客套客户端提供包括但不限于Web、Android 、iOS等多个应用版本，用户必须选择与所安装设备相匹配的软件版本。</div>
                        <div className='content-title'>2.3【本服务许可的范围】</div>
                        <div className='content-text'>2.3.1 客套智能科技给予您一项个人的、不可转让及非排他性的许可，以使用本软件。您仅可为访问或使用本服务的目的而使用这些软件及服务，不可为商业目的使用或运行本软件。</div>
                        ...
                        <div className='content-text'>3.1 您可以直接从客套官方网站找到并登录本软件的web端，可以在本软件web端下载手机端应用。</div>
                        ...
                        <div className='content-text'>4.2 客套智能科技可能还为不同的终端设备开发了不同的软件版本，您应当根据实际情况选择下载合适的版本进行安装。下载安装程序后，您需要按照该程序提示的步骤正确安装。为提供更加优质、安全的服务，在本软件安装时客套智能科技可能推荐您安装其他软件，您可以选择安装或不安装。如果您不再需要使用本软件或者需要安装新版软件，可以自行卸载。如果您愿意帮助客套智能科技改进产品服务，请告知卸载的原因。</div>
