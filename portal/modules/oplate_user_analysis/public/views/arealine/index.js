                ...
                <div className="title">
                    ...
                    <div style={{float:'right'}}>
                        <RadioGroup value={this.state.dataRange} onChange={this.onDataRangeChange}>
                            <Radio value="daily" key="daily"><ReactIntl.FormattedMessage id="operation.report.day.active" defaultMessage="日活" /></Radio>
                            <Radio value="weekly" key="weekly"><ReactIntl.FormattedMessage id="operation.report.week.active" defaultMessage="周活" /></Radio>
                            <Radio value="monthly" key="monthly"><ReactIntl.FormattedMessage id="operation.report.month.active" defaultMessage="月活" /></Radio>
                        </RadioGroup>
                    </div>
                </div>
