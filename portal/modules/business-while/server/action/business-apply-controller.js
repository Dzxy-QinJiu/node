...
exports.addBusinessWhileApply = function(req, res) {
    BusinessApplyService.addBusinessWhileApply(req, res).on('success', function(data) {
...
exports.updateBusinessWhileCustomerTime = function(req, res) {
    BusinessApplyService.updateBusinessWhileCustomerTime(req, res).on('success', function(data) {
        res.status(200).json(data);
    }).on('error', function(codeMessage) {
        res.status(500).json(codeMessage && codeMessage.message);
    });
