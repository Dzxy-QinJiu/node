            ...
            <div className='clue-info-wrap clue-detail-block'>
                ...
                {curClue.business_scope ? this.renderBasicContent(Intl.get('clue.recommend.clue.scope', '经营范围'),
                    <BasicEditInputField
                        hasEditPrivilege={false}
                        id={curClue.id}
                        value={<ShearContent className='clue-detail-company-content' rowsNum={2}>{curClue.business_scope}</ShearContent>}
                ...
                {curClue.company_profile ? this.renderBasicContent(Intl.get('clue.recommend.clue.introduction', '简介'),
                    <BasicEditInputField
                        hasEditPrivilege={false}
                        id={curClue.id}
                        value={<ShearContent className='clue-detail-company-content' rowsNum={2}>{curClue.company_profile}</ShearContent>}
