...
FilterStore.prototype.setFilterClueProvince = function(updateProvince) {
...
FilterStore.prototype.setExistedFiled = function(existedItem) {
    if (existedItem){
...
FilterStore.prototype.setUnexistedFiled = function(unexistedItem) {
    if (unexistedItem){
