...
import FilterAction from 'MOD_DIR/clue_customer/public/action/filter-action';
import clueFilterStore from 'MOD_DIR/clue_customer/public/store/clue-filter-store';
import clueCustomerAction from 'MOD_DIR/clue_customer/public/action/clue-customer-action';
import {clueStartTime, SELECT_TYPE} from 'MOD_DIR/clue_customer/public/utils/clue-customer-utils';
import ClueAnalysisStore from 'MOD_DIR/clue_customer/public/store/clue-analysis-store';
import ClueAnalysisAction from 'MOD_DIR/clue_customer/public/action/clue-analysis-action';
        ...
        data.forEach(item => {
            if (item.groupId) {
                ...
                if (item.groupId === 'clue_status'){
                    ...
                    //线索地域
                    let provinceList = _.get(item,'data');
