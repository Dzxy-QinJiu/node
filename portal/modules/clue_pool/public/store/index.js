var CluePoolAction = require('../action');
...
function CluePoolStore() {
    //初始化state数据
    this.resetState();
    this.bindActions(CluePoolAction);
}
CluePoolStore.prototype.resetState = function() {
...
CluePoolStore.prototype.setSortField = function(updateSortField) {
...
//全文查询线索
CluePoolStore.prototype.getClueFulltext = function(clueData) {
    if (clueData.loading) {
        this.isLoading = true;
...
//更新线索客户的一些属性
CluePoolStore.prototype.updateClueProperty = function(updateObj) {
...
//添加或更新跟进内容
CluePoolStore.prototype.addCluecustomerTrace = function(result) {
    if (result.loading) {
...
CluePoolStore.prototype.processForList = function(curClueLists) {
...
CluePoolStore.prototype.setCurrentCustomer = function(id) {
    if (id){
        this.currentId = id;
...
//修改信息完成后
CluePoolStore.prototype.afterEditCustomerDetail = function(newCustomerDetail) {
...
CluePoolStore.prototype.afterAddClueTrace = function(updateId) {
...
//删除某个线索
CluePoolStore.prototype.deleteClueById = function(data) {
...
CluePoolStore.prototype.updateCustomerLastContact = function(traceObj) {
