...
import {NOTICE_TYPE} from 'PUB_DIR/sources/utils/consts';
...
class UpgradeNotice extends React.Component {
                            ...
                            <div className="notices-item">
                                <li key={notice.id} className="wrapper">
                                    ...
                                    <div className="item-pubInfo">
                                        ...
                                        <span className="type">{NOTICE_TYPE[notice.type]}</span>
                                    </div>
                                </li>
                            </div>
                        );
    ...
    render() {
        const containerHeight = $(window).height() - LAYOUT.BOTTOM - LAYOUT.TAB_HEIGHT;
        return (
