 ...
 */
var SalesOppotunityApplyAjax = require('../ajax/sales-oppotunity-apply-ajax');
function SalesOppotunityApplyActions() {
    ...
    //     SalesOppotunityApplyAjax.getWorklistSalesOppotunityApplyList().then((workList) => {
    //         this.dispatch({workList: workList});
    //         SalesOppotunityApplyAjax.getAllApplyList(queryObj).then((data) => {
    ...
    //     SalesOppotunityApplyAjax.getSelfApplyList().then((data) => {
    //         this.dispatch({error: false, loading: false, data: data});
    //     }, (errorMsg) => {
    //         this.dispatch({
    //             error: true,
    ...
    //     });
    // };
    // this.getWorklistSalesOppotunityApplyList = function() {
    //     this.dispatch({error: false, loading: true});
    //     SalesOppotunityApplyAjax.getWorklistSalesOppotunityApplyList().then((data) => {
    //         this.dispatch({error: false, loading: false, data: data});
    //     }, (errorMsg) => {
    //         this.dispatch({
    //             error: true,
...
module.exports = alt.createActions(SalesOppotunityApplyActions);