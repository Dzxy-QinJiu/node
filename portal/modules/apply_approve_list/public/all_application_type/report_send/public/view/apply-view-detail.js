...
class ApplyViewDetail extends React.Component {
    ...
    addReply = (e,callback) => {
        ...
        //提交数据
        ReportSendApplyDetailAction.addApplyComments(submitData,callback);
    };
    //备注 输入框改变时候触发
    ...
    passOrRejectApplyApprove = (confirmType) => {
        ...
        ReportSendApplyDetailAction.approveApplyPassOrReject(obj, () => {
            //调用父组件的方法进行审批完成后的其他处理
            if (_.isFunction(this.props.afterApprovedFunc)) {
                this.props.afterApprovedFunc();
            }
    ...
    render() {
        ...
        return (
            <div className={detailWrapCls} style={{'width': this.props.width, 'height': this.props.height}} data-tracename="舆情报送审批详情界面">
                <ApplyDetailStatus
