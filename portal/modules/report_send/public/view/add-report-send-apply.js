        ...
        return (
            <RightPanel showFlag={true} data-tracename="添加舆情报告申请" className="add-leave-container">
                ...
                <div className="add-leave-apply-wrap">
                    <BasicData
                        clueTypeTitle={Intl.get('leave.apply.leave.application', '舆情报告申请')}
                    />
                        ...
                        <GeminiScrollbar>
                            <div className="add-leave-form">
                                <Form layout='horizontal' className="sales-clue-form" id="add-leave-apply-form">
                                    <FormItem
                                        label={Intl.get('leave.apply.leave.type','舆情报告类型')}
                                        id="leave_type"
                                        {...formItemLayout}
                                    >
                                        {
                                            getFieldDecorator('leave_type',{
                                                ...
                                                <Select
                                                    placeholder={Intl.get('leave.apply.select.leave.type','请选择舆情报告类型')}
                                                    name="leave_type"
