...
let downLoadReportSendAjax = null;
exports.downLoadReportSend = function(queryObj) {
    var Deferred = $.Deferred();
    downLoadReportSendAjax && downLoadReportSendAjax.abort();
    downLoadReportSendAjax = $.ajax({
        url: '/rest/reportsend/download',
        dataType: 'json',
        type: 'get',
        data: queryObj,
        success: function(data) {
