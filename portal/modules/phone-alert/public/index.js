                                ...
                                return (
                                    <div className="customer-name">
                                        ...
                                        <p className="show-customer-detail">
                                            <Button type="primary" onClick={this.showRightPanel.bind(this, item.id)} data-tracename="点击查看客户详情">
                    ...
                    <div>
                        <div className="customer-count-tip">
                            ...
                            {!this.state.customerUnknown && !this.state.isAddFlag ?(
                                !this.state.customerInfoArr.length?(<span>{Intl.get("call.record.no.response.customer","此号码无对应客户")}</span>):(<span>
