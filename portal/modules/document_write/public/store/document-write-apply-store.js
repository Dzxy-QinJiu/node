...
//设置是否查看未读回复的申请列表
DocumentWriteApplyStore.prototype.setIsCheckUnreadApplyList = function(flag) {
 ...
 */
DocumentWriteApplyStore.prototype.clearUnreadReply = function(applyId) {
    ...
    if (unreadReplyList) {
        ...
        this.unreadReplyList = _.filter(applyUnreadReplyList,reply => reply.type === APPLY_APPROVE_TYPES.DOCUMENT_WRITING);
...
//刷新未读回复列表;
DocumentWriteApplyStore.prototype.refreshUnreadReplyList = function(unreadReplyList) {
...
DocumentWriteApplyStore.prototype.afterTransferApplySuccess = function(targetId) {
    //查到该条记录
