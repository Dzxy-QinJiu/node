...
function ApplyViewDetailActions() {
    ...
    this.getLeaveApplyDetailById = function(queryObj, status) {
        DocumentWriteApplyAjax.getLeaveApplyDetailById(queryObj, status).then((detail) => {
    ...
    this.getLeaveApplyStatusById = function(queryObj) {
        ...
        DocumentWriteApplyAjax.getLeaveApplyStatusById(queryObj).then((list) => {
    ...
    this.getLeaveApplyCommentList = function(queryObj) {
        this.dispatch({loading: true, error: false});
        DocumentWriteApplyAjax.getLeaveApplyCommentList(queryObj).then((list) => {
            this.dispatch({loading: false, error: false, list: list});
        }, (errorMsg) => {
            this.dispatch({loading: false, error: true, errorMsg: errorMsg});
        });
    ...
    this.addLeaveApplyComments = function(obj) {
        this.dispatch({loading: true, error: false});
        DocumentWriteApplyAjax.addLeaveApplyComments(obj).then((replyData) => {
    ...
    this.cancelApplyApprove = function(obj,callback) {
        ...
        this.dispatch({loading: true, error: false});
        DocumentWriteApplyAjax.cancelApplyApprove(obj).then((data) => {
