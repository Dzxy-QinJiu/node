...
function ApplyViewDetailActions() {
    ...
    this.getApplyDetailById = function(queryObj, status) {
        DocumentWriteApplyAjax.getApplyDetailById(queryObj, status).then((detail) => {
    ...
    this.getApplyStatusById = function(queryObj) {
        ...
        DocumentWriteApplyAjax.getApplyStatusById(queryObj).then((list) => {
    ...
    this.getApplyCommentList = function(queryObj) {
        this.dispatch({loading: true, error: false});
        DocumentWriteApplyAjax.getApplyCommentList(queryObj).then((list) => {
            this.dispatch({loading: false, error: false, list: list});
        }, (errorMsg) => {
    ...
    this.addApplyComments = function(obj) {
        this.dispatch({loading: true, error: false});
        DocumentWriteApplyAjax.addApplyComments(obj).then((replyData) => {
