...
//设置是否查看未读回复的申请列表
LeaveApplyStore.prototype.setIsCheckUnreadApplyList = function(flag) {
 ...
 */
LeaveApplyStore.prototype.clearUnreadReply = function(applyId) {
    ...
    if (unreadReplyList) {
        ...
        this.unreadReplyList = _.filter(applyUnreadReplyList,reply => reply.type === APPLY_APPROVE_TYPES.PERSONAL_LEAVE);
...
//刷新未读回复列表;
LeaveApplyStore.prototype.refreshUnreadReplyList = function(unreadReplyList) {
