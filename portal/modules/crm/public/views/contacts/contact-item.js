            ...
            <div className="contact-modal-container">
                ...
                <div className="clearfix crm-contact-item">
                    ...
                    >
                        ...
                        <Modal.Footer>
                            <BootstrapButton className="btn-ok" onClick={this.deleteContact}><ReactIntl.FormattedMessage id="common.sure" defaultMessage="确定" /></BootstrapButton>
                            <BootstrapButton className="btn-cancel"
                                             onClick={this.hideDeleteContactModal}><ReactIntl.FormattedMessage id="common.cancel" defaultMessage="取消" /></BootstrapButton>
                        </Modal.Footer>
                    </Modal>
