    ...
    render() {
        ...
        return (
            <div className="app-config-content">
                ...
                >
                    <InputNumber
                        prefixCls={this.props.onlyOneUser ? "number-error-border ant-input-number" : "ant-input-number"}
                        value={appFormData.number}
                        min={1}
                        max={999}
                        onChange={this.props.onCountChange.bind(this)}/>
                </FormItem>
                {this.props.onlyOneUser ?
                ...
                >
                    {this.props.renderUserTimeRangeBlock(timePickerConfig)}
                </FormItem>
                <FormItem
                    {...formItemLayout}
                    label={Intl.get("user.expire.select", "到期可选")}
                >
                    <RadioGroup onChange={this.props.onOverDraftChange.bind(this)}
