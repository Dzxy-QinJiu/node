...
function getCharts() {
    return [
        //新增过期用户数统计
        accountChart.getAccountNumChart('added_expired', '新增过期用户数统计'),
        //新增过期用户团队统计
        accountChart.getAccountTeamChart('added_expired', '新增过期用户团队统计'),
        //地域统计
        accountChart.getAccountZoneChart('added_expired', '新增过期用户地域统计'),
        //行业统计
        accountChart.getAccountIndustryChart('added_expired', '新增过期用户行业统计'),
        //用户类型
