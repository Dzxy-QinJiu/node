...
var zh_CN = {
    ...
    'menu.trace': '跟进记录',
    'menu.appuser': '用户管理',
    'menu.appuser.list': '已有用户',
    'menu.appuser.org': '组织管理',
    'menu.appuser.auditlog': '用户审计日志',
    ...
    'user.app.open': '开通应用',
    'user.no.app': '暂无应用',
    'user.no.related.app': '无相关应用',//暂无符合条件的应用
    'user.app.select.tip': '至少选择一个应用',
    ...
    'role.add.role': '添加角色',
    'role.add.auth': '添加权限',
    'role.no.auth.set': '未设置权限，请先{setting}',
    'role.set.auth': '设置权限',
    'role.no.auth.add': '未设置权限，请先{add}', // 未设置权限，请先添加权限
    'role.no.set.auth.add': '暂无权限,请先{add}',// 暂无权限,请先添加权限
    'role.del.role.tip': '确定要删除这个角色吗？',

    'role.all.hide': '全部收起',
    'role.all.show': '全部展开',
    'role.no.role.list': '暂无角色列表',
    'role.get.role.list.failed': '获取角色列表失败',
    'role.del.role.failed': '删除角色失败',
    'role.add.role.failed': '添加角色失败',
    'role.edit.role.failed': '修改角色失败',
    'role.role.list': '角色列表',
    'role.import.role': '导入角色',
    'role.export.role': '导出角色',
    'role.template': '《角色模板》',
    'role.default.set': '默认',
    'role.default.del': '取消默认',
    ...
    'authority.del.group': '确定要删除这个权限组吗？',
    'authority.del.auth': '确定要删除该权限吗',
    'authority.del.select.auth': '确定要删除选中的权限吗?',
    'authority.auth.type': '权限类型',
    'authority.auth.api': '服务地址',
    'authority.data.auth': '数据权限',
    'authority.auth.flag': '权限标识',
    //转移到xxx分组
    'authority.turn.to': '转移到',
    'authority.auth.group.name': '权限组名',
    'authority.input.length.tip': '最少1个字符,最多200个字符',
    'authority.saving.group.name': '正在保存组名',
    'authority.current.auth': '当前权限',
    'authority.all.select': '全选',
    'authority.invert.select': '反选',
    'authority.add.new.auth': '添加一个新权限',
    'authority.need.write.one': '必填一项*',
    'authority.need.write.one.api': '必填一项服务地址',
    'authority.need.write.one.data': '必填一项数据权限',
    'authority.auth.name': '权限名称',
    'authority.group.name': '分组名称',
    'authority.add.new.module': '添加一个权限信息模块',
    'authority.no.auth.list': '暂无权限列表',
    'authority.del.auth.failed': '删除权限失败',
    'authority.del.group.failed': '删除权限组失败',
    'authority.add.auth.failed': '添加权限失败',
    'authority.edit.auth.failed': '修改权限失败',
    'authority.auth.list': '权限列表',
    'authority.import.auth': '导入权限',
    'authority.export.auth': '导出权限',
    'authority.template': '《权限模板》',
    'authority.search.by.server.address': '请输入服务地址搜索',
    'authority.permission.exist': '该权限名已存在',
    'authority.edit.is.save': '是否保存修改的权限组名',
    /*权限管理模块-end*/
    //后台管理-成员start
    'member.member': '成员',
    ...
    'my.app.app.auth.title': '应用权限',
    'my.app.app.secret.key': '密钥',
    'my.app.app.secret.refresh': '{refresh}',
    'my.app.app.secret.modal.content': '确定要刷新密钥吗？',
    'my.app.change.expire.time': '修改到期时间',
    'my.app.change.expire.time.error': '修改应用到期时间失败',
    'my.app.change.expire.time.placeholder': '请选择到期时间',
    'my.app.no.auth': '暂无数据, {clickTips}',
    'my.app.click.add': '点击添加',
    'my.app.auth.method': '请求方式',
    'my.app.auth.path': '请求路径',
    'my.app.get.app.failed': '获取我的应用失败',
    'my.app.no.app': '暂无应用',
    //我的应用end
    // 安全域start
    'realm.title': '安全域管理',
    'realm.search.placeholder': '安全域名称/域名',
    'realm.add.realm': '添加安全域',
    'realm.name': '域名',
    'realm.industry': '行业',
    'realm.address': '地址',
    ...
    'realm.change.owner.password.placeholder': '6-18位字符(由数字，字母，符号组成)',
    'realm.change.owner.phone.tip': '电话、邮箱必填一项！',
    'realm.edit.address.placeholder': '请选择地址',
    'realm.edit.address.detail.placeholder': '详细地址，例如街道名称，门牌号码等信息',
    'realm.select.address.province': '省份',
    'realm.select.address.city': '城市',
    'realm.select.address.country': '县区',
    'realm.select.industry.placeholder': '请选择行业!',
    'realm.select.industry1': '计算机/互联网/通信/电子',
    'realm.select.industry2': '贸易/消费/制造/营运',
    'realm.select.industry3': '制药/医疗',
    'realm.select.industry4': '广告/媒体',
    'realm.select.industry5': '房地产/建筑',
    'realm.select.industry6': '专业服务/教育/培训',
    'realm.select.industry7': '服务业',
    'realm.select.industry8': '物流/运输',
    'realm.select.industry9': '能源/原材料',
    'realm.select.industry10': '政府/非盈利机构/其他',
    'realm.disable.modal': '是否禁用此安全域？',
    'realm.enable.modal': '是否启用此安全域？',
    'realm.check.realm.name.message': '请输入数字、字母或连接符，首字母不能是连接符',
    'realm.no.realm': '暂无安全域!',
    'realm.no.match.realm': '没有符合条件的安全域!',
    'realm.company': '公司',
    'realm.email.host': '服务器地址',
    'realm.email.host.message': '请输入邮件服务器地址',
    'realm.email.port': '端口',
    'realm.email.port.message': '请输入邮件服务器端口号',
    'realm.email.protocol': '发送协议',
    'realm.email.protocol.message': '请输入发送邮件协议',
    'realm.email.title': '邮箱服务器配置信息',
    'realm.email.edit.title': '修改邮箱服务器的配置信息',
    'realm.email.set.title': '配置邮箱服务器',
    'realm.email.set.error': '配置邮箱服务器失败',
    'realm.sms.username': '请输入短信网关用户名',
    'realm.sms.password.message': '请输入短信网关密码',
    'realm.sms.title': '短信服务器配置信息',
    'realm.sms.edit.title': '修改短信服务器的配置信息',
    'realm.sms.set.title': '配置短信服务器',
    'realm.sms.set.error': '配置短信服务器失败',
    'realm.wechat.id.label': 'ID',
    'realm.wechat.id.placeholder': '请输入微信公众号ID',
    'realm.wechat.secret.label': '密钥',
    'realm.wechat.secret.placeholder': '请输入微信公众号密钥',
    'realm.wechat.title': '微信公众号配置信息',
    'realm.wechat.edit.title': '修改微信公众号的配置信息',
    'realm.wechat.set.title': '配置微信公众号',
    'realm.wechat.set.error': '配置微信公众号失败',
    // 安全域end
    //基本资料start
    ...
    'call.record.caller.search.placehoder': '呼叫者',
    ...
    'crm.197': '客户名称只能包含汉字、字母、数字、横线、下划线、点、中英文括号等字符，且长度在1到50（包括50）之间',
    ...
    'operation.report.app.login': '各应用登录情况',
    'operation.report.app.new.account': '新开用户',
    'operation.report.new.account.statistic.': '新开通用户统计',
    'operation.report.login.comparison': '近四周登录情况对比',
    'operation.report.login.total.time.user.comparison': '近四周周在线总时长超过1小时的用户数对比',
    'operation.report.expire.login.comparison': '近四周到期用户登录情况对比',
    'operation.report.signed.user.comparison': '近四周签约用户登录情况对比',
    'operation.report.new.open.comparison': '近四周新开通用户情况对比',
    'operation.report.department': '部门',
    'operation.report.total.login': '一、总体登录情况',
    'operation.report.this.week.total.login.tip': '1、本周共有{num}个（上周{lastWeekNum}个）用户登录了应用',
    'operation.report.login.comparison.chart': '2、近四周登录情况对比图如下所示:',
    'operation.report.user.activity.chart': '3、截止{curTime}，应用总计{total}个用户，本周的活跃度为{percent}({curData}/{total})，近四周的用户活跃度对比图如下所示:',
    'operation.report.user.activity.comparison': '近四周用户活跃度对比',
    'operation.report.app.login.time.comparison': '4、本周共有{total}个（上周{lastWeekTotal}个）用户周在线总时长超过1小时，占比为{percent}({total}/{loginTotal})，近四周各应用周在线总时长超过1小时的用户数对比图如下所示:',
    'operation.report.user.activity.daily.chart': '5、{startTime}至{endTime},各应用每日用户登录情况如下图所示：',
    'operation.report.user.login.team.table': '6、登录用户的部门分布情况如下表所示：',
    'operation.report.expire.user.login': '二、过期用户登录情况',
    'operation.report.expire.user.login.tip': '1、本周共有{num}个(上周{lastWeekNum}个)过期用户登录了应用。',
    'operation.report.expired.total.login.time.tip': '2、本周共有{total}个过期用户周在线总时长超过1小时： ',
    'operation.report.app.online.expired.user.count': '{appName}{count}个 ',
    'operation.report.total.average.login.tip': '共有{num}个(上周{lastWeekNum}个)过期用户一周内平均每天登录8个小时以上，具体情况如下表所示：',
    'operation.report.expired.user.login.comparison': '3、近四周过期用户登录情况对比图如下所示:',
    'operation.report.expired.login.comparison.chart': '4、近四周过期用户登录情况对比图',
    'operation.report.open.account.login': '三、新开通试用用户登录情况',
    'operation.report.open.trial.app.distribute': '1、本周共开设{num}个(上周{lastWeekNum}个)试用用户，应用分布情况如下图所示：',
    'operation.report.open.account.statistic': '新开通试用用户情况统计',
    'operation.report.open.user.comparison.chart': '2、近四周新开通试用用户情况对比图如下所示:',
    'operation.report.open.user.comparison': '近四周新开通试用用户对比',
    'operation.report.open.trial.team.tip': '3、新开通试用用户部门分布情况如下表所示:',
    'operation.report.open.trial.login.tip': '4、新开通试用用户共登录{count}个（上周{lastWeekCount}个）,占比{percent}({count}/{allCount}),上周占比{lastWeekPercent}({lastWeekCount}/{lastWeekAllCount}),部门分布情况如下表所示:',
    'operation.report.total.week.login.tip': '5、共有{count}个试用用户周在线总时长超过1小时，部门分布情况如下表所示:',
    'operation.report.signed.account.login': '四、签约用户登录情况',
    'operation.report.singed.user.login.percent.tip': '1、本周共有{count}个(上周{lastWeekCount})签约用户登录各应用,占本周登录总用户数的{percent}({count}/{allCount}),上周{lastWeekPercent}（{lastWeekCount}/{allCount}）。',
    'operation.report.app.singed.user.login.tip': '其中{appName}{count}个，占{appName}总签约用户数的{percent}（{count}/{total}）,上周{lastWeekPercent}({lastWeekCount}/{total}）；',
    'operation.report.singed.user.login.table.tip': '签约用户登录情况的部门分布如下表所示：',
    'operation.report.singed.user.login.tip': '2、近四周签约用户登录情况对比图如下所示：',
    'operation.report.delay.user.login': '五、延期用户登录情况',
    'operation.report.delay.user.app.distribute': '1、本周新增了{num}个(上周{lastWeekNum}个)延期用户，应用分布情况如下图所示：',
    'operation.report.delay.user.statistic': '新增延期用户情况统计',
    'operation.report.app.delay.user': '延期用户',
    'operation.report.delay.user.comparison.chart': '2、近四周新增延期用户情况对比图如下所示:',
    'operation.report.delay.user.comparison': '近四周新增延期用户对比',
    'operation.report.delay.user.team.tip': '3、新增延期用户部门分布情况如下表所示:',
    'operation.report.delay.user.login.tip': '4、新增延期用户共登录{count}个（上周{lastWeekCount}个）,占比{percent}({count}/{allCount}),上周占比{lastWeekPercent}({lastWeekCount}/{lastWeekAllCount}),部门分布情况如下表所示:',
    'operation.report.delay.user.week.login.tip': '5、共有{count}个延期用户周在线总时长超过1小时，部门分布情况如下表所示:',
    'operation.report.activity': '活跃度',
    'operation.report.activity.percent': '活跃度(%)',
    'operation.report.active.num': '活跃数',
    'operation.report.active.count': '活跃数(个)',
    'operation.report.total.num': '总数',
    'operation.report.total.count': '总数(个)',
    ...
    //安全域分析-开启时间统计
    'oplate_bd_analysis_realm_establish.5': '当前安全域开通总数',
    'oplate_bd_analysis_realm_establish.6': '安全域开通总数',
    'oplate_bd_analysis_realm_establish.7': '近一周',
    'oplate_bd_analysis_realm_establish.8': '近一月',
    'oplate_bd_analysis_realm_establish.9': '近一年',
    //安全域分析-行业统计
    ...
    'clue.download.clue.csv': '下载导入{type}表格',
