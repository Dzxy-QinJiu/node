...
var zh_CN = {
    ...
    'crm.197': '客户名称只能包含汉字、字母、数字、横线、下划线、点、中英文括号等字符，且长度在1到25（包括25）之间',
    ...
    'app.user.manage.custom.variable.key.tip': '请输入自定义属性的key',
    'app.user.manage.custom.variable.des.tip': '请输入自定义属性的描述',
