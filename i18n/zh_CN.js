...
var zh_CN = {
    ...
    'common.login.time.require.msg': '请输入时间',
    ...
    'login.account.unregister': '该账号尚未注册',

    'register.title.tip': '欢迎注册客套',
    'register.slogan.tip': '销售加速，从这里开始 ...',
    'register.enter.website': '进入官网',
    ...
    'user.login.analysis.order': '机会分析',
    ...
    'user.trade.record.order.number': '机会号',
    'user.trade.record.time': '机会时间',
    ...
    'sales.stage.add.order.stage': '添加机会阶段',
    ...
    'sales.stage.lost': '流失',
    'sales.stage.toplimit': '机会阶段个数已达上限（8个）',
    //销售阶段end
    //销售团队start
    ...
    'crm.stage.tag': '阶段标签',
    'crm.order.more.customer': '多个机会的客户',
    ...
    'crm.basic.no.source': '暂无获客方式',
    'crm.basic.add.source': '添加获客方式',
    'crm.basic.select.source': '请选择获客方式',
    'crm.basic.set.source': '设置获客方式',
    ...
    'crm.order.closing': '机会关闭中',
    'crm.order.close.failed': '关闭机会失败',
    ...
    'crm.order.close.step': '关闭机会',
    'crm.order.update.confirm': '确定要修改机会阶段吗？',
    'crm.order.close.win.confirm': '确定将机会的关闭状态设为赢单吗？',
    ...
    'oplate_customer_analysis.11': '机会阶段统计',
    ...
    'business.trip.go.out.cannot.over.day': '外出时长不可以跨天',
    ...
    'errorcode.deal.stage.error': '机会阶段错误',
    'errorcode.stage.count.limit.tip': '阶段个数超限',
    'errorcode.stage.name.limit.tip': '阶段名称字数超限',
    'errorcode.stage.description.limit.tip': '阶段描述字数超限',
    ...
    'errorcode.stage.delete.tips': '存在该阶段的机会，请修改后再删除',
    ...
    //统计分析及报告部分 国际化补充
    'analysis.total.conversion': '总转化率',
    'analysis.reach': '到',
    'analysis.conversion.rate': '转化率',
    'analysis.account.number.statistics': '账号数统计',
    'analysis.apply.all': '全部应用',
    'analysis.months.later': '{count}个月后',
    'analysis.account.status.statistics': '账号状态统计',
    'analysis.account.type.statistics': '账号类型统计',
    'analysis.statistics.of.effective.accounts': '有效账号数统计',
    'analysis.no.charge': '未收费数',
    'analysis.number.of.charges': '收费数',
    'analysis.telephone.industry.statistics': '电话行业统计',
    'analysis.opportunity.conversion.rate.statistics': '机会转化率统计',
    'analysis.number.of.submissions': '提交数',
    'analysis.pass.number': '通过数',
    'analysis.transaction.trend.statistics': '成交趋势统计',
    'analysis.opportunity.details': '销售机会明细',
    'analysis.transfer.to.team': '转入团队',
    'analysis.sign.or.not': '是否签单',
    'analysis.new.opportunity.statistics': '新机会统计',
    'analysis.statistics.of.lead.turnover.and.turnover': '线索成交额及成交数统计',
    'analysis.transaction.channel.statistics': '成交渠道统计',
    'analysis.classified.statistics.of.transactions': '成交数分类统计',
    'analysis.statistical.comparison.of.quantity.in.the.same.period.of.history': '历史同期数量统计对比',
    'analysis.all.channels': '全部渠道',
    'analysis.all.sources': '全部来源',
    'analysis.cash.loss.rate': '现金流失率',
    'analysis.and.above': '及以上',
    'analysis.contact.customer.interval.statistics': '联系客户间隔统计',
    'analysis.statistics.of.customer.churn.rate': '客户流失率统计',
    'analysis.number.of.lost.customers': '流失客户数',
    'analysis.churn.rate': '流失客户率',
    'analysis.lost.gross.profit': '流失毛利',
    'analysis.gross.profit.loss.rate': '毛利流失率',
    'analysis.number.of.customers.statistics': '客户数统计',
    'analysis.total.customers': '总客户数',
    'analysis.within.six.months': '6个月内',
    'analysis.transaction.analysis': '成交分析',
    'analysis.number.of.outstanding.transactions': '未成交数',
    'analysis.statistics.of.active.rate.of.effective.customers': '负责客户活跃率统计',
    'analysis.statistics.of.active.rate.of.follow.customers': '联合跟进客户活跃率统计',
    'analysis.cash.loss.trend': '流失现金趋势',
    'analysis.analysis.on.the.general.situation.of.lost.customers': '流失客户总体情况分析',
    'analysis.application': '应用',
    'analysis.analysis.of.lost.customer.team': '流失客户团队分析',
    'analysis.customer.churn.trend': '流失客户趋势',
    'analysis.regional.analysis.of.lost.customers': '流失客户地域分析',
    'analysis.weekly.contact.customer.statistics': '周联系客户统计',
    'analysis.co.contact.count.customers': '共联系{count}个客户',
    'analysis.renew.customer.gross.profit.analysis': '续签客户毛利分析',
    'analysis.number.of.customers': '客户个数',
    'analysis.contract.gross.profit.before.renewal': '续约前合同毛利',
    'analysis.contract.gross.profit.after.renewal': '续约后合同毛利',
    'analysis.growth.rate.of.renewal.amount': '续约金额增长率',
    'analysis.customer.renewal.time.statistics': '客户续签时间统计',
    'analysis.number.of.customers.due': '到期客户数',
    'analysis.renewal.of.current.month': '当月续签',
    'analysis.renewal.customer.trend': '续签客户趋势',
    'analysis.renewal.customer.region.analysis': '续签客户地域分析',
    'analysis.analysis.of.market.share.of.administrative.level.of.contracted.customers': '签约客户行政级别市场占有率分析',
    'analysis.number.of.provincial.customers': '省级客户数',
    'analysis.provincial.share': '省级占有率',
    'analysis.number.of.municipal.customers': '市级客户数',
    'analysis.city.share': '市级占有率',
    'analysis.number.of.county.customers': '县级客户数',
    'analysis.county.occupancy': '县级占有率',
    'analysis.gross.profit.analysis.of.contracted.customers': '签约客户毛利分析',
    'analysis.expand': '拓展',
    'analysis.analysis.of.net.increase.of.contracted.customers': '签约客户净增分析',
    'analysis.click.the.number.on.the.net.increase.analysis.form.of.contracted.customers.to.view.the.detailed.list': '点击签约客户净增分析表格上的数字查看详细列表',
    'analysis.distribution.of.newly.signed.industries': '新签行业分布',
    'analysis.distribution.of.newly.signed.teams': '新签团队分布',
    'analysis.new.customer.trend': '新签客户趋势',
    'analysis.industry.distribution.of.contracted.customers': '签约客户行业分布',
    'analysis.distribution.of.contracted.customer.teams': '签约客户团队分布',
    'analysis.general.trend.of.contracted.customers': '签约客户总体趋势',
    'analysis.analysis.of.regional.market.share.of.contracted.customers': '签约客户地域市场占有率分析',
    'analysis.transfer.out.customer.details': '转出客户明细',
    'analysis.trend.of.number.of.customers.transferred.out': '转出客户数趋势',
    'analysis.detailed.statistical.table.of.trial.qualification': '试用合格详细统计表',
    'analysis.qualified.composition.in.probation.this.month': '本月试用合格组成',
    'analysis.region': '区域',
    'analysis.number.of.trial.customers.opened': '已开通试用客户数',
    'analysis.number.of.valid.login.customers': '有效登录客户数',
    'analysis.statistics.of.qualified.customers.in.probation.this.month': '本月试用合格客户数统计',
    'analysis.order.turnover.trend': '机会成交率趋势',
    'analysis.click.the.sales.behavior.statistics.on.the.sales.personal.report.page.to.view.the.detailed.list': '点击销售个人报告页面上的销售行为统计拜访客户数查看详细列表',
    'analysis.travel.leave.statistics': '出差请假统计',
    'analysis.number.of.business.trips': '出差次数',
    'analysis.annual.recurring.income': '年经常性收入情况',
    'analysis.personal.statistics': '个人统计',
    'analysis.cost.statistics': '费用统计',
    'analysis.year.on.year.growth.of.performance': '业绩同比增长情况',
    'analysis.first.half.of.the.year': '上半年',
    'analysis.second.half': '下半年',
    'analysis.statistical.interval': '统计区间',
    'analysis.statistical.scope': '统计范围',
    'analysis.near.count.year': '近{count}年',
    'analysis.industry.distribution': '行业分布',
    'analysis.completion.statistics': '完成情况统计',
    'analysis.false.data': '假数据',
    'analysis.product.distribution': '产品分布',
    'analysis.a.number.of.contracts': '合同个数',
    'analysis.collection.gross.profit.statistics': '回款毛利统计',
    'analysis.comparison.of.gross.profit.of.payment.collection.in.the.same.period': '回款毛利同期对比',
    'analysis.estimated.collection.statistics': '预计回款统计',
    'analysis.collection.type.comparison': '回款类型对比',
    'analysis.section.statistics.of.contract.amount': '合同额分段统计',
    'analysis.more.than.ten.thousand': '万以上',
    'analysis.less.than.ten.thousand': '万以下',
    'analysis.team.distribution': '团队分布',
    'analysis.geographical.distribution': '地域分布',
    'analysis.search.by.keyword': '根据关键词搜索',
    'analysis.view.weekly.report.details': '查看周报详情',
    'analysis.select.team': '选择团队',
    'analysis.time.frame': '时间范围',
    'analysis.select.the.some.year': '选择第{year}年',
    'analysis.select.the.some.week': '选择第{week}周',
    'analysis.statistics.of.qualified.customers': '合格客户数统计',
    'analysis.attendance.statistics': '出勤统计',
    'analysis.sales.report': '销售报告',
    'analysis.number.of.contracts': '合同数',
    'analysis.number.of.follow-up.customers': '跟进客户数',
    'analysis.number.of.calls': '电话数',
    'analysis.customer.activity.rate': '客户活跃率',
    'analysis.submit.opportunity': '提交机会',
    'analysis.sales.ranking': '销售排名',
    'analysis.ranking.within.the.team': '团队内排名',
    'analysis.ranking.within.superior.team': '上级团队内排名',
    'analysis.ranking.in.sales.department': '销售部内排名',
    'analysis.configure.report.view': '配置报告视图',
    'analysis.open.report.view': '开启报告视图',
    'analysis.click.the.open.button': '点击开启按钮',
    'analysis.sales.daily.report.right.panel': '销售日报右侧面板',
    'analysis.report.details.view': '报告详情视图',
    'analysis.click.on.the.table.row': '点击表格行',
    'analysis.view.report.details': '查看报告详情',
    'analysis.view.the.list.of.subordinate.team.reports': '查看下级团队报告列表',
    'analysis.daily.sales.report.list': '销售日报列表',
    'analysis.view.digital.details': '查看数字详情',
    'analysis.click.operation.button': '点击{operation}按钮',
    ...
    'clue.list.no.clue.name': '无线索名',
    'clue.list.no.crm.name': '无客户名',
    ...
    'analysis.travel.statistics': '出差统计',
    'analysis.excuse.for.leave': '请假事由',
    'analysis.days.off': '请假天数',
    'analysis.leave.statistics': '请假统计',
    'analysis.out.place': '外出地点',
    'analysis.date.of.departure': '外出日期',
    ...
    'analysis.someone.report.details': '{someone}的报告详情',
    'analysis.rules.set': '规则设置',
    'analysis.open.report': '开启报告',
    'analysis.by.day': '按日',
    'analysis.according.to.week': '按周',
    'analysis.confirm.to.open': '确认开启',
    'analysis.report.saved.successfully': '保存报告成功',
    'analysis.changed.report.rule.setting.successfully': '修改报告规则设置成功',
    'analysis.changed.report.status.successfully': '修改报告启停状态成功',
    'analysis.check.the.report': '查看报告',
    'analysis.enable.reports.to.summarize': '启用报告可以汇总销售日常工作',
    'analysis.fill.in.the.report': '填写报告',
    'analysis.i.got.it': '我知道了',
    'analysis.content.of.the.report': '报告内容',
    'analysis.the.rules.set': '规则设置',
    'analysis.daily.work': '日常工作',
    'analysis.the.other.work': '其他工作',
    ...
    'lead.check.phone.fiald': '空号检测失败',
    'lead.check.phone.upgrade.tip': '升级后可检测空号',
    'lead.check.phone.renewal.tip': '续费后可检测空号',
    'lead.check.phone.status.other.tip': '标示号码是危险号码、不存在或沉默号。',
    'lead.check.phone': '空号检测',
    'lead.check.phone.only.phone': '仅手机号',
    'lead.check.phone.single.tip': '此线索有{allCount}个号码，系统帮您发现了{emptyCount}个疑似空号。',
    'lead.check.phone.no.real.count.tip': '此线索的手机号没有实号，是否提取？',
    'lead.check.phone.batch.tip': '系统帮您发现了{emptyCount}条线索全部疑似空号。',
    ...
    'lead.check.phone.no.empty.number': '非疑似空号',
    ...
    'shear.expand': '展开',
    'crm.order.stage.manage': '机会阶段管理',
    'crm.order.stage.add': '添加机会阶段',
    'crm.order.stage.edit': '编辑机会阶段',
    'crm.order.stage.name': '阶段名称',
    'crm.order.stage.name.placeholder': '请输入阶段名称',
    'crm.order.stage.destrip.palceholder': '请输入阶段的描述信息',
    'crm.order.stage.nodata.tips': '暂无机会阶段，请先添加',
    ...
    'leave.apply.marry.leave': '婚假',
    'leave.apply.funner.leave': '丧假',
    'leave.apply.maternity.leave': '产假',
    'leave.apply.maternity.nursing.leave': '产护假',
    ...
    'apply.approve.distribute.team': '分配团队',
    'leave.apply.select.assigned.sales': '请选择要分配的销售',
    'apply.approve.select.assigned.team': '请选择要分配的团队',
    ...
    'deal.manage': '机会管理',
    'deal.list.get.failed': '获取机会列表失败',
    'deal.no.data': '暂无机会',
    'deal.stage': '阶段',
    'deal.budget': '预算(元)',
    'deal.no.more.tip': '没有更多机会了',
    'deal.total.tip': '共{count}个机会',
    'deal.total.budget.tip': '共{count}元',
    'deal.stage.select.tip': '请选择机会阶段',
    'deal.detail.panel.title': '机会详情',
    'deal.detail.no.products': '暂无产品',
    'deal.no.filter.deal': '没有符合条件的机会',
    'deal.view.board': '看板视图',
    'deal.view.list': '表格视图',
    'deal.drag.data.saving': '正在保存拖动的数据...',
    'deal.drag.data.disabled': '关闭的机会不可以修改',
    ...
    'apply.approve.simple.report': '简报',
    ...
    'apply.total.business.while.time': '共{totalTime}',
    ...
    'bussiness.trip.time.range.no.empty': '拜访时间不能为空',
    'bussiness.while.time.range.no.empty': '外出时间不能为空',
    'business.while.trip.time.range': '外出时间',
    'business.while.trip.go.out': '外出',
    'business.while.position.num': '地点{num}',
    'business.leave.time.range': '出差时长',
    'business.change.total.time': '请修改时间再添加',
    'business.leave.time.no.overlay': '外出时间不要重复',
    'business.leave.time.is.required': '外出地域是必填项',
    'business.customer.time.is.required': '地域是必填项',
    ...
    'apply.eefung.data.service': '数据导出',
    ...
    'clue.recommend.industry.name': '行业名称',
    'clue.recommend.established.time': '成立时间',
    'clue.recommend.company.size': '公司规模',
    'clue.recommend.registered.capital': '注册资本',
    'clue.recommend.enterprise.class': '企业类型',
    'clue.recommend.condition.register.size': '{num}年以内',
    'clue.recommend.condition.register.range': '{min}-{max}年',
    'clue.recommend.condition.register.over.num': '{num}年以上',
    'clue.recommend.fitler.advanced.options': '高级选项',
    'clue.recommend.extract.success.tip': '提取成功！ 去{leads}查看',
    'clue.recommend.selected.tip': '已选{count}条',
    'clue.recommend.filter.vip': 'VIP筛选',
    'clue.recommend.filter.name.no.limit': '{name}不限',
    'clue.recommend.filter.selected': '已选条件',
    'clue.recommend.filter.company.status': '企业状态',
    'clue.recommend.filter.company.status.survival': '存续',
    'clue.recommend.filter.company.status.employment': '在业',
    'clue.recommend.filter.company.status.revoked': '吊销',
    'clue.recommend.filter.company.status.cancellation': '注销',
    'clue.recommend.filter.company.status.immigration': '迁入',
    ...
    'clue.recommend.register.half.year': '近半年注册',
    ...
    'payment.goods.number': '机会号：{orderNumber}',
    ...
    'payment.order.record': '机会记录',
    'payment.add.clue.extracted.number': '您已成功增加{count}条线索提取量',
    'payment.again.create.order': '重新生成',
    'payment.order.timeout': '机会超时，{retry}',
    'payment.again.create.order.faild': '生成机会失败，{retry}',
    'payment.renewal': '续费',
    ...
    'payment.platform.order.no': '平台机会机会号',
    ...
    'personal.welcome.enter.system': '进入系统',
    /*个人试用 --- end*/
