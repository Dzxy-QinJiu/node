...
var zh_CN = {
    ...
    'user.import.username.rule': '用户名规则：长度为1到50的字母、数字、横线、下划线',
    'user.import.phone.rule': '手机规则：13、14、16、17、18、19开头的11位手机号',
    'user.import.email.rule': '邮箱规则：数字、字母、下划线 + @ + 数字、英文 + . +英文',
    'user.import.yellow.tips': '黄色标示系统未找不到对应的客户，可以继续导入，导入后需要自行设置客户。',
