...
var zh_CN = {
    ...
    "user.time.all": "全部时间",
    "user.time.today": "今天",
    "user.time.today1": "今日{expired}",
    "user.time.will.expired": "即将到期的{tryandassigned}",
    "user.time.yesterday": "昨天",
    "user.time.this.week": "本周{expired}",
    "user.time.prev.week": "上周",
    "user.time.this.month": "本月{expired}",
    "user.time.prev.month": "上月",
    "user.time.half.year": "半年内{expired}",
