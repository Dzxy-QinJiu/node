...
var en_US = {
    ...
    'click.ctrl.upload.mutil.file': 'You can upload multiple files at the same time, only upload image files, text files and compressed files. The file size should not exceed 10M!',//可同时上传多个文件，只能上传图片文件，文本文件缩文件，文件大小不要超过10M！
